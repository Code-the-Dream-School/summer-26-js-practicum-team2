    ...
    <div className="mx-auto max-w-3xl py-8">
      <Card className="flex flex-col gap-4">
        ...
        <p className="text-body leading-normal text-foreground">
          Sprout is provided as-is for educational purposes as part of the Code the Dream JavaScript
          Practicum. By using Sprout you agree to the following:
        </p>
        <ul className="list-inside list-disc space-y-2 text-body text-foreground">
          ...
          <li>
            You understand that{" "}
            <strong>
              this app provides general financial education only and is not personalized financial,
              legal, tax, investment, or credit advice
            </strong>
            . Consider consulting a qualified professional before making any financial decisions.
          </li>
        </ul>
        <p className="text-body leading-normal text-foreground">
