  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <input
        ...
        className={`w-full rounded-xl border px-3 py-2 text-sm shadow-sm outline-none transition-all duration-200 focus:ring-4 disabled:cursor-not-allowed ${inputStateClasses} ${className}`}
        {...props}
      />
