...
This checklist should be used prior to publishing or approving any content. Please complete the accuracy and grammar review together. Content must not be approved just because it "looks good".

## Accuracy review

- [ ] Numbers are realistic and relevant to the context, and calculations are correct.
...
- [ ] Grammar, spelling, punctuation, readability, and accessibility have been reviewed at the same time as factual accuracy.
- [ ] Headings, examples, links, and labels accurately describe the content they introduce.
- [ ] The final reviewer has checked all checklist items rather than relying on a subjective "looks good" approval.
